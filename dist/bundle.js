...
var callsiteTostring$3;
var hasRequiredCallsiteTostring$3;

function requireCallsiteTostring$3 () {
	if (hasRequiredCallsiteTostring$3) return callsiteTostring$3;
	hasRequiredCallsiteTostring$3 = 1;

	/**
	 * Module exports.
	 */

	callsiteTostring$3 = callSiteToString;
...
var eventListenerCount_1$3;
var hasRequiredEventListenerCount$3;

function requireEventListenerCount$3 () {
	if (hasRequiredEventListenerCount$3) return eventListenerCount_1$3;
	hasRequiredEventListenerCount$3 = 1;
	...
	eventListenerCount_1$3 = eventListenerCount;
...
(function (module) {
	...
	lazyProperty(module.exports, 'callSiteToString', function callSiteToString () {
	  ...
	  return stack[0].toString ? toString : requireCallsiteTostring$3()
	});

	lazyProperty(module.exports, 'eventListenerCount', function eventListenerCount () {
	  return EventEmitter.listenerCount || requireEventListenerCount$3()
	});
...
var callSiteToString$2 = compat$3.exports.callSiteToString;
var eventListenerCount$2 = compat$3.exports.eventListenerCount;
var relative$3 = require$$1__default["default"].relative;
...
function requireStatuses$1 () {
	if (hasRequiredStatuses$1) return statuses$8;
...
function requireInherits$1 () {
	if (hasRequiredInherits$1) return inherits$2.exports;
	...
	(function (module) {
		try {
		  ...
		  module.exports = requireInherits_browser$2();
		}
} (inherits$2));
...
function requireHttpErrors$1 () {
	if (hasRequiredHttpErrors$1) return httpErrors$2.exports;
...
function requireDebug () {
	if (hasRequiredDebug) return debug$7.exports;
	hasRequiredDebug = 1;
...
var callsiteTostring$2;
var hasRequiredCallsiteTostring$2;

function requireCallsiteTostring$2 () {
	if (hasRequiredCallsiteTostring$2) return callsiteTostring$2;
	hasRequiredCallsiteTostring$2 = 1;

	/**
	 * Module exports.
	 */

	callsiteTostring$2 = callSiteToString;
...
var eventListenerCount_1$2;
var hasRequiredEventListenerCount$2;

function requireEventListenerCount$2 () {
	if (hasRequiredEventListenerCount$2) return eventListenerCount_1$2;
	hasRequiredEventListenerCount$2 = 1;
	...
	eventListenerCount_1$2 = eventListenerCount;
...
function requireCompat () {
	if (hasRequiredCompat) return compat$2.exports;
	hasRequiredCompat = 1;
	(function (module) {
		...
		lazyProperty(module.exports, 'callSiteToString', function callSiteToString () {
		  ...
		  return stack[0].toString ? toString : requireCallsiteTostring$2()
		});

		lazyProperty(module.exports, 'eventListenerCount', function eventListenerCount () {
		  return EventEmitter.listenerCount || requireEventListenerCount$2()
		});
...
function requireDepd () {
	if (hasRequiredDepd) return depd_1$3;
	hasRequiredDepd = 1;
	/**
	 * Module dependencies.
	 */

	var callSiteToString = requireCompat().callSiteToString;
	var eventListenerCount = requireCompat().eventListenerCount;
...
function requireStatuses () {
	if (hasRequiredStatuses) return statuses$7;
...
function requireHttpErrors () {
	if (hasRequiredHttpErrors) return httpErrors$1.exports;
...
function requireStreams () {
	...
	var Buffer = require$$0__default$2["default"].Buffer,
	    Transform = require$$1__default$4["default"].Transform;
	...
	extendNode = function (iconv) {
	    ...
	    iconv.extendNodeEncodings = function extendNodeEncodings() {
	        ...
	        if (iconv.supportsStreams) {
	            var Readable = require$$1__default$4["default"].Readable;
...
function requireRead () {
	...
	var zlib = require$$4__default$1["default"];
...
function requireStringify$1 () {
	...
	stringify_1$1 = function (object, opts) {
	    var obj = object;
...
function requireParse$1 () {
	if (hasRequiredParse$1) return parse$8;
...
function requireUrlencoded () {
	...
	var deprecate = depd_1$4('body-parser');
	var read = requireRead();
	var typeis = typeIs.exports;
...
var statuses$6 = status$3;

// status code to message map
status$3.STATUS_CODES = codes$3;

// array of status codes
status$3.codes = populateStatusesMap$3(status$3, codes$3);
...
var debug$6 = src.exports('finalhandler');
...
var defer = typeof setImmediate === 'function'
  ? setImmediate
  : function (fn) { process.nextTick(fn.bind.apply(fn, arguments)); };
var isFinished = onFinished$3.isFinished;
...
function send$3 (req, res, status, headers, message) {
  function write () {
    ...
    res.statusMessage = statuses$5[status];
...
var debug$5 = src.exports('express:router:layer');
...
var http$2 = require$$0__default$4["default"];
...
var debug$4 = src.exports('express:router:route');
...
var callsiteTostring$1;
var hasRequiredCallsiteTostring$1;

function requireCallsiteTostring$1 () {
	if (hasRequiredCallsiteTostring$1) return callsiteTostring$1;
	hasRequiredCallsiteTostring$1 = 1;

	/**
	 * Module exports.
	 */

	callsiteTostring$1 = callSiteToString;
...
var eventListenerCount_1$1;
var hasRequiredEventListenerCount$1;

function requireEventListenerCount$1 () {
	if (hasRequiredEventListenerCount$1) return eventListenerCount_1$1;
	hasRequiredEventListenerCount$1 = 1;
	...
	eventListenerCount_1$1 = eventListenerCount;
...
(function (module) {
	...
	lazyProperty(module.exports, 'callSiteToString', function callSiteToString () {
	  ...
	  return stack[0].toString ? toString : requireCallsiteTostring$1()
	});

	lazyProperty(module.exports, 'eventListenerCount', function eventListenerCount () {
	  return EventEmitter.listenerCount || requireEventListenerCount$1()
	});
...
var callSiteToString$1 = compat$1.exports.callSiteToString;
var eventListenerCount$1 = compat$1.exports.eventListenerCount;
var relative$2 = require$$1__default["default"].relative;
...
var debug$3 = src.exports('express:router');
var deprecate$4 = depd_1$2('express');
...
proto.param = function param(name, fn) {
  ...
  if (typeof name === 'function') {
    deprecate$4('router.param(fn): Refactor to use path params');
  ...
  if (name[0] === ':') {
    deprecate$4('router.param(' + JSON.stringify(name) + ', fn): Use router.param(' + JSON.stringify(name.substr(1)) + ', fn) instead');
    name = name.substr(1);
  }
...
var debug$2 = src.exports('express:view');
...
var statuses$4 = status$2;

// status code to message map
status$2.STATUS_CODES = codes$2;

// array of status codes
status$2.codes = populateStatusesMap$2(status$2, codes$2);
...
var Stream$1 = require$$1__default$4["default"];
...
var Stats = require$$1__default$2["default"].Stats;
...
// array of status codes
status$1.codes = populateStatusesMap$1(status$1, codes$1);
...
var debug$1 = src.exports('send');
var deprecate$3 = depd_1$1('send');
...
var Stream = require$$1__default$4["default"];
var util = require$$1__default$1["default"];
...
function forwarded$1 (req) {
  ...
  var proxyAddrs = parse$4(req.headers['x-forwarded-for'] || '');
...
(function (exports) {
	...
	var contentType$1 = contentType;
	var deprecate = depd_1$2('express');
	var flatten = arrayFlatten_1;
...
(function (module, exports) {
	...
	var flatten = arrayFlatten_1;
	var merge = utilsMerge.exports;
	var resolve = require$$1__default["default"].resolve;
	var setPrototypeOf = setprototypeof;
	var slice = Array.prototype.slice;
...
var deprecate$2 = depd_1$2('express');
var isIP = require$$4__default["default"].isIP;
var typeis = typeIs.exports;
var http$1 = require$$0__default$4["default"];
var fresh = fresh_1;
var parseRange = rangeParser_1;
var parse$3 = parseurl$1.exports;
var proxyaddr = proxyAddr.exports;
...
var contentDisposition = contentDisposition$2.exports;
var deprecate$1 = depd_1$2('express');
...
res.send = function send(body) {
  ...
  if (arguments.length === 2) {
    ...
    if (typeof arguments[0] !== 'number' && typeof arguments[1] === 'number') {
      deprecate$1('res.send(body, status): Use res.status(status).send(body) instead');
      this.statusCode = arguments[1];
    } else {
      deprecate$1('res.send(status, body): Use res.status(status).send(body) instead');
  ...
  if (typeof chunk === 'number' && arguments.length === 1) {
    ...
    deprecate$1('res.send(status): Use res.sendStatus(status) instead');
...
res.json = function json(obj) {
  ...
  if (arguments.length === 2) {
    ...
    if (typeof arguments[1] === 'number') {
      deprecate$1('res.json(obj, status): Use res.status(status).json(obj) instead');
      this.statusCode = arguments[1];
    } else {
      deprecate$1('res.json(status, obj): Use res.status(status).json(obj) instead');
      this.statusCode = arguments[0];
      val = arguments[1];
    }
  }
...
res.jsonp = function jsonp(obj) {
  ...
  if (arguments.length === 2) {
    // res.json(body, status) backwards compat
    if (typeof arguments[1] === 'number') {
      deprecate$1('res.jsonp(obj, status): Use res.status(status).json(obj) instead');
      this.statusCode = arguments[1];
    } else {
      deprecate$1('res.jsonp(status, obj): Use res.status(status).jsonp(obj) instead');
      this.statusCode = arguments[0];
      val = arguments[1];
    }
  }
...
res.redirect = function redirect(url) {
  ...
  if (arguments.length === 2) {
    if (typeof arguments[0] === 'number') {
      ...
      deprecate$1('res.redirect(url, status): Use res.redirect(status, url) instead');
      status = arguments[1];
    }
  }
...
res.vary = function(field){
  ...
  if (!field || (Array.isArray(field) && !field.length)) {
    deprecate$1('res.vary(): Provide a field name');
    return this;
  }
...
morgan$1.exports = morgan;
morgan$1.exports.compile = compile;
morgan$1.exports.format = format;
morgan$1.exports.token = token;
...
var auth = basicAuth.exports;
var debug = src.exports('morgan');
var deprecate = depd_1('morgan');
var onFinished = onFinished$5.exports;
...
app.use(morgan$1.exports("dev"));
app.use(express.static(
  "/home/runner/Happy-Birthday/public"
));
